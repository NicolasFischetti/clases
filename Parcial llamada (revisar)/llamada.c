    ...
    if(limite > 0 && array != NULL)
    {
        ...
        do
        {
            ...
            for(i=0;i<limite-1;i++)
            {
                    if(array[i].isEmpty == OCUPADO && array[i+1].isEmpty == OCUPADO )
                    {
                        if((strcmp(array[i].idLlamada,array[i+1].id) > 0 && !orden) || (strcmp(array[i].idLlamada,array[i+1].idLlamada) < 0 && orden)) //<------------
                        {
                            auxiliar = array[i];
                            array[i] = array[i+1];
                            array[i+1] = auxiliar;
    ...
    if(limite > 0 && array != NULL)
    {
        ...
        do
        {
            ...
            for(i=0;i<limite-1;i++)
            {
                    if(array[i].isEmpty == OCUPADO && array[i+1].isEmpty == OCUPADO )
                    {
                        if((strcmp(array[i].idMotivo,array[i+1].id) > 0 && !orden) || (strcmp(array[i].idMotivo,array[i+1].idMotivo) < 0 && orden)) //<------------
                        {
                            auxiliar = array[i];
                            array[i] = array[i+1];
                            array[i+1] = auxiliar;
